...
To get started with this guide, please refer to [installation-flow](install.md) and complete the following steps :
...
Asset creation uses the Enterprise datatoken template, like this:
