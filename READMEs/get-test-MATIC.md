...
# Get Test MATIC and Verify It

Mumbai is Polygon's testnet. 

you develop on Ocean, you'll often need to use the MATIC token. It's an ERC20 token on Ethereum mainnet, along with bridges to other networks and testnet deployments.
