...
### Appendix. Consuming from the Binance API

Consume here is just like in [consume-flow](READMEs/consume-flow.md]. The file downloaded is a .json. Its shape is a list of lists, looking something like:
```text
...
For details of the Binance API, go to [its docs](https://binance-docs.github.io/apidocs/spot/en/#compressed-aggregate-trades-list) for spot trades, and search for "Kline/Candlestick Data" or "api/v3/klines".
