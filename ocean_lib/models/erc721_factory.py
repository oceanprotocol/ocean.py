...
class ERC721FactoryContract(ERCTokenFactoryBase):
    ...
    def create_nft_with_erc20(
        ...
        datatoken_publish_market_fee_token: str,
        datatoken_cap: int,
        datatoken_publish_market_fee_amount: int,
            ...
            (
                ...
                (
                    ...
                    [
                        ...
                        datatoken_publish_market_fee_token,
                    ],
                    [datatoken_cap, datatoken_publish_market_fee_amount],
                    datatoken_bytess,
                ),
            ),
            from_wallet,
        ...
        return self.send_transaction(
            ...
            (
                ...
                (
                    [
                        pool_rate,
                        pool_basetoken_decimals,
                        pool_vesting_amount,
                        pool_vesting_blocks,
                        pool_basetoken_amount,
                    ],
                    [
                        pool_lp_swap_fee,
                    ...
                    [
                        pool_side_staking,
                        pool_basetoken,
                        pool_basetoken_sender,
                        pool_publisher,
                        pool_publish_market_fee_collector,
        ...
        return self.send_transaction(
            ...
            (
                ...
                (
                    fixed_price_address,
                    [
                        fixed_price_basetoken,
                        fixed_price_owner,
                        fixed_price_publish_market_fee_collector,
                    ],
                    [
                        fixed_price_basetoken_decimals,
