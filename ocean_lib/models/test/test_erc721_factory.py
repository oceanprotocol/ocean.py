...
def test_main(web3, config, publisher_wallet, consumer_wallet, another_consumer_wallet):
    ...
    tx = erc721_factory.create_nft_erc20_with_pool(
        ...
        datatoken_bytess=[b""],
        pool_rate=to_wei("1"),
        pool_basetoken_decimals=erc20_token.decimals(),
        pool_vesting_amount=initial_pool_liquidity
        // 100
        * 9,  # max 10% vesting amount of the total cap
        pool_vesting_blocks=2500000,
        pool_basetoken_amount=initial_pool_liquidity,
        pool_lp_swap_fee=to_wei("0.001"),
        pool_publish_market_swap_fee=to_wei("0.001"),
        pool_side_staking=side_staking_address,
        pool_basetoken=erc20_address,
        pool_basetoken_sender=erc721_factory_address,
        pool_publisher=publisher_wallet.address,
        pool_publish_market_fee_collector=consumer_wallet.address,
    ...
    tx = erc721_nft.create_erc20(
        ...
        publish_market_fee_token=ZERO_ADDRESS,
        cap=to_wei("0.5"),
        publish_market_fee_amount=to_wei("0.0005"),
        bytess=[b""],
        from_wallet=publisher_wallet,
    )
