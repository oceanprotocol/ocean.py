...
def test_create_compute_service(publisher_ocean_instance, config):
    ...
    service = publisher_ocean_instance.services.create_compute_service(
        config, attributes, "http://provider.com:8030"
    )
    assert (
